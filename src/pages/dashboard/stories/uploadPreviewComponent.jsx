...
export default function UploadPreviewComponent({
                                                   type,
                                                   fileUrl,
                                                   handleChange,
                                                   title,
    ...
    return (
        <Box key={name} sx={{display: 'block', width: "50%", gap: 2}}>
            <Box key={name}
                 sx={{display: 'flex', justifyContent: "space-between", width: "100%", alignItems: 'start', gap: 2}}>
                <Button
                    variant="contained"
                    component="label"
            ...
            {fileUrl && (
                <Box sx={{maxWidth: '100%', display:"flex",justifyContent: "center",  maxHeight: 400}}>
                    {type == 'image' ? (
                        ...
                        <video controls
                               style={{width: '219px', height: '279px', alignContent: "center", borderRadius: "16px"}}>
